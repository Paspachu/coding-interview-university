...
- [X] TopCoder (includes recurrence relations and master theorem): **Leet Code 46: Permutations**
...
- ### Arrays
    ...
    - [X] Time
        - O(1) to add/remove at end (amortized for allocations for more space), index, or update
            - Python: append, access, pop last, count
        - O(n) to insert/remove elsewhere
            - Python: insert, pop, index, del, remove, clear
    - [X] Space
...
- ### Stack
    ...
    - [X] Just remember that a stack is LIFO (Last-In First-Out)
    - [ ] Leetcode problems:
...
- ### Queue
    ...
    - [X] Just remember that a queue is FIFO (First-In First-Out)
...
- ### Hash table
    - [ ] Videos:
        ...
        - [X] [Data Structures Easy to Advanced Course - Full Tutorial from a Google Engineer](https://www.youtube.com/watch?v=RBSGKlAvoiM&list=PLUzvZMEoR0KvEthotRQR3qoJ5FJxkhvaP&ab_channel=freeCodeCamp.org): Start from 3:59:26
    ...
    - [X] Implement with array using linear probing
        - [X] hash_table(m) - m is the size of the hash table
        - [X] empty()
...
- ### Binary search
    ...
    - [ ] [blueprint](https://leetcode.com/discuss/general-discussion/786126/python-powerful-ultimate-binary-search-template-solved-many-problems): Start from 1482
...
- [ ] Implement:
    - [X] Bubble sort: O(n^2) average and worst-case
    - [X] Selection sort: O(n^2) average and worst-case
    - [X] Insertion sort: O(n^2) average and worst-case
    - [X] Merge sort: O(n log n) average and worst case
    - [X] Quick sort O(n log n) average case
